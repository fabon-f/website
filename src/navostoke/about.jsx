...
export default data =>
    <main role="main">
        ...
        <p>「ナヴァストーケ」は、2021年10月に活動を開始した<a href="/">ふぁぼん</a>の個人サークルです。主に評論・情報系の同人誌を出しますが、一次・二次問わず物語を作ることもあります。</p>
        <p>科学、コンピュータ、ロシア語、ロシア・旧ソ連、公共交通など、幅広い分野に対する知識・愛・こだわりを掛け算した作品を主に作っています。また、専門知識・能力をフル活用して解像度の高い作品を作ることを活動目標の1つに据えています。</p>

        <section>
            <h2>名前の由来</h2>
            <p>サークル名の「ナヴァストーケ」は、ロシア語で「東で」を意味する「на востоке」を発音優先で日本語に転写したものです。</p>
